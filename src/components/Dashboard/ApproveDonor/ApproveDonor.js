                                ...
                                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
                                    {
                                        donors.map((donor, index) => (
                                            <div key={index} className='my-4'>
                                                ...
                                                <button
                                                    className={`px-5 py-2 mt-4 text-white capitalize transition-colors duration-300 transform rounded-md lg:w-auto focus:outline-none font-Poppins ${disabledButtons[index] ? 'bg-gray-400 cursor-not-allowed' : 'bg-red-500 hover:bg-gray-600'}`}
