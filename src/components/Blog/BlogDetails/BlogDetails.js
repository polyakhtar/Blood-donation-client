...
const BlogDetails = () => {
 ...
 const [blogDetails,setBlogDetails]=useState(null);
  ...
  // Display a loading state while fetching the blog details
...
.then(data=>{
  ...
  return (
    ...
    <div className=''>
          {/* blog post banner section start */}
  ...
  <p className='font-semibold font-Poppins ml-16'>Please <Link className='text-blue-500 underline' to='/login'>log in</Link> to leave a comment.</p>
)}
</div>
