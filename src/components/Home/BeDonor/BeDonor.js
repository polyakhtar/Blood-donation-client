...
const BeDonor = () => {
    ...
    WE HAVE BEEN HELPING PEOPLE SINCE 40 YEARS</h1>
      ...
      <button className="w-2/5 px-5 py-2 mt-4 text-white capitalize transition-colors duration-300 transform bg-gray-700 rounded-md lg:w-auto hover:bg-gray-800 focus:outline-none font-Poppins"><Link to='/donorform'>BECOME DONOR</Link></button>
            </div>
            </div>
            </div>
