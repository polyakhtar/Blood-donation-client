            ...
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row items-center">
                  <input id="email" type="text" className="px-5 py-1 text-gray-700 bg-white border rounded-md focus:border-red-500 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-red-300 font-Poppins" value={email} onChange={handleInputChange} placeholder="Email Address" />
                  <Link to={'/payment'}>
