...
const Counter = () => {
  ...
  return (
    <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='container mx-auto lg:my-20 md:my-16 my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8' style={{paddingLeft:'8%',paddingRight:'8%'}}>
